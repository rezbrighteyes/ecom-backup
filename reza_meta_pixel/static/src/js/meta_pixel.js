document.addEventListener('DOMContentLoaded', () => {
    ...
    // PageView already fired from head script

    // ViewContent — handled in XML template

    // InitiateCheckout — fires on the checkout page (any variant of URL)
    if (path.includes('/checkout')) {
        trackEvent('InitiateCheckout');
    }

    // InitiateCheckout — also fires when clicking Proceed to Checkout from cart
